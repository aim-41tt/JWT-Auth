...
public class AdaptiveThreadPoolConfig {
    ...
    /**
     * Настройка асинхронного пула потоков.
     * Используется для управления задачами в сервисе управления пользователями.
     */
    ...
    protected Executor taskExecutor() {
        ...
        // Максимальное количество потоков - в 2 раза больше базового, можно регулировать в зависимости от характера задач
        ...
        // Вместо простого логирования, можно использовать CallerRunsPolicy, чтобы выполнить задачу в вызывающем потоке.
